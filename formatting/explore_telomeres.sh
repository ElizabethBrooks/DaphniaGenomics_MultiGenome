...
#$ -m abe
#$ -r n
#$ -N extract_telomeres_jobOutput

# script to extract telomere sequences
# usage: qsub extract_telomeres.sh inputFile
...
tidk explore -f $inputsDir"/complete.genomic.fna" > $outputsPath"/tidk_0.2.65/telomeric_repeat.tsv"
