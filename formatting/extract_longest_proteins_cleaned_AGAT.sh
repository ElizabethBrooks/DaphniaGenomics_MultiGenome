...
#$ -m abe
#$ -r n
#$ -N extract_clean_prot_AGAT_jobOutput
...
singularity exec --bind $PWD:/AGAT $softwarePath"/agat_1.4.2--pl5321hdfd78af_0.sif" agat_sp_extract_sequences.pl -gff $outputsPath"/AGAT/output_longest.gff" -f $outputsPath"/complete.genomic.fna" -p -o $outputsPath"/AGAT/longest_protein_cleaned.fa" --clean_final_stop --clean_internal_stop
