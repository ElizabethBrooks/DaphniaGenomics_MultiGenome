...
#$ -m abe
#$ -r n
#$ -N run_cached_EGAPx_v0.3.2_jobOutput
#$ -pe smp 15

# script to run the EGAPx v0.3.2 pipeline
# usage: qsub run_cached_EGAPx_v0.3.2_HPC.sh inputFile
# usage ex: qsub run_cached_EGAPx_v0.3.2_HPC.sh EGAPx_v0.3.2/D_mendotae/inputs_67B_v2_ZQ.txt
