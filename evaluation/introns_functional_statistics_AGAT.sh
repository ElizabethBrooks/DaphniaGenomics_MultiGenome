...
#$ -m abe
#$ -r n
#$ -N introns_fun_stats_AGAT_jobOutput

# script to summerize functional information in the input gff
# usage: qsub introns_functional_statistics_AGAT.sh inputFile
...
#inputsDir=$(grep "outputs_EGAPx_v0.5.2_NCBI:" ../"inputData/inputs_annotations.txt" | tr -d " " | sed "s/outputs_EGAPx_v0.5.2_NCBI://g")
...
# pre-clean
rm -r $outputsPath"/AGAT_v1.4.2/introns_functional_stats"

# run AGAT
agat_sp_functional_statistics.pl -gff $outputsPath"/AGAT_v1.4.2/introns.gff" -g $inputsDir"/complete.genomic.fna" -o $outputsPath"/AGAT_v1.4.2/introns_functional_stats"
