...
# run AGAT
singularity exec --bind $PWD:/AGAT_v1.4.2 $softwarePath"/agat_1.4.2--pl5321hdfd78af_0.sif" agat_sp_functional_statistics.pl -gff $outputsPath"/complete.genomic.gff" -f $outputsPath"/complete.genomic.fna" -o $outputsPath"/AGAT_v1.4.2/functional_stats.txt"
