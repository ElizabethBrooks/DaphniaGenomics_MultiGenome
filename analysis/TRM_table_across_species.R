...
work_dir <- "/Users/bamflappy/PfrenderLab/multi_genome_project/telomeres_min4_max12"
setwd(work_dir)

# read in TRM data
trm_data <- read.csv("/Users/bamflappy/PfrenderLab/multi_genome_project/telomeres_min4_max12/telomeric_repeat_formatted.csv")
