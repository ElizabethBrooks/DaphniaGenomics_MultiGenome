...
mkdir /afs/crc.nd.edu/user/e/ebrooks5/egapx_temp_datapath_local
...
python3 /afs/crc.nd.edu/user/e/ebrooks5/egapx/ui/egapx.py /afs/crc.nd.edu/user/e/ebrooks5/egapx/examples/input_D_farinae_small.yaml -e singularity -w /afs/crc.nd.edu/user/e/ebrooks5/egapx_temp_datapath_local/D_farinae -o example_out

# clean up
rm -r /afs/crc.nd.edu/user/e/ebrooks5/egapx_temp_datapath_local
